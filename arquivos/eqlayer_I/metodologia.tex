...
\section{Fundamentals of magnetic equivalent layer and the positive magnetic-moment distribution}
...
%% Discretizing layer
\section{Parametrization and forward problem}
...
\section{Iterative algorithm for solving the inverse problem}
...
\section{The choice of layer depth $\mathbf{z_{c}}$ and regularization parameter $\mathbf{\mu}$}
